...
def handle_TextMessage(event):
    ...
    msg = 'I can tell from your words that you are very sad. Do you want to see a cute corgi?'
...
def handle_ImageMessage(event):
    line_bot_api.reply_message(
    event.reply_token,
    TextSendMessage(text="What a cute corgi!")
    )
...
def handle_LocationMessage(event):
    line_bot_api.reply_message(
    event.reply_token,
    TextSendMessage(text="I am sure your city has many cute corgi, welcome to share with us")
    )
